...
public class AnalyzePLCProgramPlusV2 extends GhidraScript {
    ...
    private String readmeText() {
        return "# PLC Program Plus Analysis Export\n\n"+
            ...
            "## Recommended reading order\n\n1. `preflight.md`\n2. `plc_analysis_summary.md`\n3. `ANALYSIS_WARNINGS.md`\n4. `core_functions.md`\n5. `source_crosswalk.md`, when present\n6. `source_function_candidates.csv`, when present\n7. `variable_access.csv` and `literal_pools.csv`\n8. `function_inventory.csv`\n9. `metadata_strings.csv`\n10. `call_edges.csv` and `indirect_calls.csv`\n11. Selected folders and `SELECTION_README.md` under `core_function_details/`\n\n"+
    ...
    private String codexPrompt() {
        return "Read AGENTS.md first, then analyze this PLC-BEAD Ghidra export.\n\nStart with preflight.md, plc_analysis_summary.md, ANALYSIS_WARNINGS.md, core_functions.md, source_crosswalk.md if present, function_inventory.csv, source_function_candidates.csv if present, variable_access.csv, literal_pools.csv, metadata_strings.csv, call_edges.csv, and indirect_calls.csv.\n\nExplain the likely toolchain, separate probable PLC control logic from runtime/support code, compare core functions against the Structured Text source, and treat unresolved CODESYS indirect calls as provisional. Use raw assembly as stronger evidence than decompiled C. Do not modify or patch binaries.\n";
    }
